...
urlpatterns = [
    ...
    path('areas/<str:especialidad>/facturas/', documentos_views.facturas_area, name='facturas_area'),
    ...
    path('patrocinios/dossier/<str:idioma>/subir/', views.subir_dossier, name='subir_dossier'),
